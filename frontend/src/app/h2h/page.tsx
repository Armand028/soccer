  ...
  async function handleCompare() {
    ...
    try {
      const [analysisData, reportData] = await Promise.all([
        fetchFullAnalysis(teamA, teamB, league),
        fetchAnalysisReport(teamA, teamB, league),
      ]);
    ...
    <div className="space-y-6 pb-20 lg:pb-0">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Compare two teams&apos; history and current form with AI analysis
        </p>
      </div>
        ...
        <CardContent className="pt-6">
          <div className="grid gap-4 sm:grid-cols-4">
            ...
            <button
              ...
              className="h-10 px-4 rounded-md bg-primary text-primary-foreground font-medium text-sm hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <Card className="border-primary/30">
          <CardContent className="py-6">
            <div className="text-center space-y-2">
              <p className="text-xs text-muted-foreground uppercase tracking-widest">{league}</p>
